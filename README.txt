...
Commands:
	Run with console input		runs the kwic program accepting line input via
								the console
	Run with file input			runs the kwic program accepting line input via
								the file which is set in kwic/config by the
								LINE_INPUT_FILE variable
